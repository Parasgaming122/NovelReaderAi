...
export class FanqiePlugin implements NovelSourcePlugin {
  public info: PluginSourceInfo = {
    ...
    blocked: true,
    blockedReason: 'Site requires JavaScript rendering / app-based — server-side scraping not possible',
    cfBlockLevel: 'full',
    cfStatus: 'Fanqie Novel is app-based. Server-side requests time out. Requires browser bypass.',
