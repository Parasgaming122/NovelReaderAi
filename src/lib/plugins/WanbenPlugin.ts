...
const BASE = 'https://www.10000txt.com';

export class WanbenPlugin implements NovelSourcePlugin {
  public info: PluginSourceInfo = {
    ...
    language: 'zh',
    version: '1.0.0',
    icon: 'https://raw.githubusercontent.com/Parasgaming122/external-sources/main/icons/wanben.png',
    hasSearch: true,
    charset: 'UTF-8',
