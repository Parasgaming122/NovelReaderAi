...
const BASE = 'https://www.haodoo.net';

export class HaodooPlugin implements NovelSourcePlugin {
  public info: PluginSourceInfo = {
    ...
    language: 'zh',
    version: '1.0.0',
    icon: 'https://raw.githubusercontent.com/Parasgaming122/external-sources/main/icons/haodoo.png',
    hasSearch: false,
    charset: 'UTF-8',
    description: 'Haodoo Chinese novel library with search and catalog.',
    blocked: true,
    blockedReason: 'Traditional Chinese (繁體) archive site — uses ?M=hd&P=martial URL structure, not chapter-based novels',
    cfBlockLevel: 'full',
    cfStatus: 'Haodoo is a Traditional Chinese TXT archive (好讀). Not compatible with chapter-based plugin architecture.',
