...
export class SnapdPlugin implements NovelSourcePlugin {
  public info: PluginSourceInfo = {
    ...
    blocked: true,
    blockedReason: 'Search endpoint returns 404 — catalog works only via categories',
    cfBlockLevel: 'partial',
    cfStatus: 'Catalog pages accessible, but search (/s?q=) returns 404. Browse-only source.',
