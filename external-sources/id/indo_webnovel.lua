...
if bp_ok and bp then
    print("[indo_webnovel] ✓ Bypass loaded")
else
    print("[indo_webnovel] ⚠ Direct HTTP mode")
end
...
language = "id"
icon     = "https://indowebnovel.id/wp-content/uploads/2022/12/cropped-Phoenix-PNG-32x32.png"
...
function getBookDescription(bookUrl)
  ...
  -- Remove h1 header from synopsis
  local cleaned = el.html
  
  local el = html_select_first(cleaned, ".container .adsads, .chapter-content, #chapter-content")
