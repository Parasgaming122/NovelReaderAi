...
if bp_ok and bp then
    print("[mvlempyr.com] ✓ Bypass loaded")
else
    print("[mvlempyr.com] ⚠ Direct HTTP mode")
end
...
local function loadAll()
    local r = fetchPage(chapSite .. "wp-json/wp/v2/mvl-novels?per_page=10000")
if not r then
...
if not r then return nil end
    ...
    local cr = fetchPage(chapSite .. "wp-json/wp/v2/posts?tags=" .. tostring(novelId) .. "&orderby=date&order=desc&per_page=1")
