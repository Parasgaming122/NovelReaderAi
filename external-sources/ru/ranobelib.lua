...
if bp_ok and bp then
    print("[ranobelib] ✓ Bypass loaded")
else
    print("[ranobelib] ⚠ Direct HTTP mode")
end
...
function getCatalogList(index)
  ...
  local r = fetchPage(url, { headers = apiHeaders })
...
local function fetchBookJson(bookUrl)
  ...
  local r = fetchPage(apiBase .. slug, { headers = apiHeaders })
...
function getChapterList(bookUrl)
  ...
  local r = fetchPage(apiBase .. slug .. "/chapters", { headers = apiHeaders })
if not r then
